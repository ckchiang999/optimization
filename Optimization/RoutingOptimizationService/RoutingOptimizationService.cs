...
namespace RoutingOptimizationService
{
    ...
    /// </summary>
    internal sealed class RoutingOptimizationService : StatelessService
    {
        public RoutingOptimizationService(StatelessServiceContext context)
            : base(context)
        { }
            ...
            return new ServiceInstanceListener[]
            {
                new ServiceInstanceListener(serviceContext =>
                    new KestrelCommunicationListener(serviceContext, "ServiceEndpoint", (url, listener) =>
                    {
                        ...
                        builder.Services.AddScoped<IRoutingOptimization, RoutingOptimizationEngine>();
